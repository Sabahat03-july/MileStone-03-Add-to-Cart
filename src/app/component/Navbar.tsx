...
const Navbar = () => {
  ...
  return (
    <nav className=' bg-[#c4ebe1] shadow-inner shadow-[#D84727]  w-full '> 
      <div className="max-w-screen-full flex justify-between items-center py-3 px-4 sm:px-8 md:px-16">
        
        {/* Logo */}
        <div>
          <h1 className="text-[#115528] font-[800] pt-2 text-[20px] uppercase">Rolex® </h1>
        </div>

        {/* Navigation */}
        <div className="hidden md:flex">
          <ul className="text-[#115528] flex gap-[20px] pt-2 font-[500] text-[18px]">
      ...
      {isMenuOpen && (
        <div className="md:hidden flex flex-col items-center py-4 bg-[#F1DDC9] h-[200px]">
          <ul className="text-[#115528] flex flex-col gap-4 font-[500] text-[18px]">
